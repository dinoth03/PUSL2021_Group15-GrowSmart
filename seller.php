...
<div class="container mt-5">
    ...
    <form id="addProductForm" action="<?= $editData ? 'controller/updateProducts.php' : 'controller/addProducts.php' ?>" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" name="productName" id="productName" class="form-control" required value="<?= $editData['productname'] ?? '' ?>">
            </div>
            <div class="col-md-6">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                ...
                <input type="number" name="productPrice" id="productPrice" class="form-control" required value="<?= $editData['price'] ?? '' ?>">
            </div>
            <div class="col-md-6">
                <label for="productWeight">Pieces</label>
                <input type="text" name="productWeight" id="productWeight" class="form-control" required value="<?= $editData['weight'] ?? '' ?>">
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <input type="text" name="imageUrl" id="imageUrl" class="form-control" required value="<?= $editData['imageurl'] ?? '' ?>">
            </div>
        </div>
    ...
    <button type="submit" class="btn btn-sm btn-warning">Edit</button>
                        ...
                        <!-- Delete button -->
                        <form method="post" action="controller/deleteProducts.php" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this product?');">
