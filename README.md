...
## Summary :- 
GrowSmart achieved its goal by providing a user-friendly sustainable platform which uses personalized advice and community engagement capabilities to assist gardeners and operate an eco-friendly marketplace. The existing restrictions of the AI system were noted alongside payment simulation boundaries and scalability requirements and regional language support needs in the limitation section. For future phases of GrowSmart the Further Work section recommended enhancing the platform through development of a broader AI knowledge base and complete payment incorporation and mobile apps and improved community management capabilities. 
