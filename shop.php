...
<body>
    ...
    <!-- Plant Listing -->
    <div class="container">
        <div class="section-header" id="categoryHeaderPlants" data-category="plants" style="display: none;">
            <h2 style="text-align: center; padding-left: -10%;">Plants</h2>
        </div>
        <br>
        <div class="row" id="productListPlants">

            <div class="col-md-3 product-card" data-category="plants" data-name="snakeplant">

                <div class="card">
                    <img src="Images/snakeplant.jpg" class="card-img-top" alt="Snakeplant" data-toggle="modal"
                        data-target="#snakeplantModal">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn add-to-cart cart-button" data-product-id="snakeplantModal"
            ...
            <!-- Product Modal -->
            <div class="modal fade" id="snakeplantModal" tabindex="-1" aria-labelledby="snakeplantModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="snakeplantModalLabel">Snake Plant Details</h3>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img src="Images/snakeplant.jpg" class="img-fluid" alt="Snakeplant">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="card-text"><strong>Price:</strong> Rs.500.00</p>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn   add-to-cart" data-product-id="snakeplantModal"
                                data-bs-dismiss="modal">Add to Cart</button>
            ...
            <div class="col-md-3 product-card" data-category="plants" data-name="anthurium">

                <div class="card">
                    <img src="Images/anthurium.jpg" class="card-img-top" alt="anthurium" data-toggle="modal"
                        data-target="#anthuriumModal">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn add-to-cart cart-button" data-product-id="anthuriumModal"
                            data-bs-dismiss="modal">Add to Cart</button>
                        <button type="button" class="btn buy-now cart-button">Buy Now</button>
                    </div>
                </div>
            ...
            <!-- Product Modal -->
            <div class="modal fade" id="anthuriumModal" tabindex="-1" aria-labelledby="anthuriumModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="anthuriumModalLabel">Anthurium Plant Details</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img src="Images/anthurium.jpg" class="img-fluid" alt="anthurium">
                                </div>

                                <div class="col-md-6">
                                    <h4 class="card-title">Anthurium</h4>
                                    <p><strong>Seller:</strong> John Smith</p>
                                    <p><strong>Seller Address:</strong> No.205, Galle Rd, Galle.</p>
                                    <p><strong>Rating:</strong> ⭐⭐⭐⭐ (4.5)</p>
                                    <p><strong>Pices:</strong> 1 Pcs</p>
                                    <p class="card-text"><strong>Price:</strong> Rs.300.00</p>
                                    <p><strong>Shipping:</strong> Free</p>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn   add-to-cart" data-product-id="anthuriumModal"
                                data-bs-dismiss="modal">Add to Cart</button>
                            <button type="button" class="btn btn-success">Buy Now</button>
                        </div>
                    </div>
            ...
            <div class="col-md-3 product-card" data-category="plants" data-name="airpurifierliveplant">

                <div class="card">
                    <img src="Images/AirPurifierLiveplant.jpg" class="card-img-top" alt="AirPurifierLiveplant" data-toggle="modal"
                        data-target="#airpurifierliveplantModal">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Air Purifier Live Plant</h5>
                        <div>
                            <p>1 Pcs</p>
                        </div>
                        <p class="card-text">Price: Rs.800.00</p>
                        <button type="button" class="btn add-to-cart cart-button" data-product-id="airpurifierliveplantModal"
                            data-bs-dismiss="modal">Add to Cart</button>
                        <button type="button" class="btn buy-now cart-button">Buy Now</button>
                    </div>
                </div>
            ...
            <!-- Product Modal -->
            <div class="modal fade" id="airpurifierliveplantModal" tabindex="-1" aria-labelledby="airpurifierliveplantModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="airpurifierliveplantModalLabel">Air Purifier Live Plant Details</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img src="Images/AirPurifierLiveplant.jpg" class="img-fluid" alt="AirPurifierLiveplant">
                                </div>

                                <div class="col-md-6">
                                    <h4 class="card-title">Air Purifier Live Plant</h4>
                                    <p><strong>Seller:</strong> John Smith</p>
                                    <p><strong>Seller Address:</strong> No.205, Galle Rd, Galle.</p>
                                    <p><strong>Rating:</strong> ⭐⭐⭐⭐ (4.5)</p>
                                    <p><strong>Pices:</strong> 1.00 Pcs</p>
                                    <p class="card-text"><strong>Price:</strong> Rs.800.00</p>
                                    <p><strong>Shipping:</strong> Free</p>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn   add-to-cart" data-product-id="airpurifierliveplantModal"
                                data-bs-dismiss="modal">Add to Cart</button>
                            <button type="button" class="btn btn-success">Buy Now</button>
                        </div>
                    </div>
            ...
            <div class="col-md-3 product-card" data-category="plants" data-name="guldavari">

                <div class="card">
                    <img src="Images/Guldavari.jpg" class="card-img-top" alt="Guldavari" data-toggle="modal"
                        data-target="#snakeplantModal">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Guldavari Plant</h5>
                        <div>
                            <p>1.00 Pcs</p>
                        </div>
                        <p class="card-text">Price: Rs.600.00</p>
                        <button type="button" class="btn add-to-cart cart-button" data-product-id="guldavariModal"
                            data-bs-dismiss="modal">Add to Cart</button>
                        <button type="button" class="btn buy-now cart-button">Buy Now</button>
                    </div>
                </div>
            ...
            <!-- Product Modal -->
            <div class="modal fade" id="guldavariModal" tabindex="-1" aria-labelledby="guldavariModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="guldavariModalLabel">Guldavari Plant Details</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img src="Images/Guldavari.jpg" class="img-fluid" alt="Guldavari">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Rating:</strong> ⭐⭐⭐⭐ (4.5)</p>
                                    <p><strong>Pices:</strong> 1.00 Pcs</p>
                                    <p class="card-text"><strong>Price:</strong> Rs.600.00</p>
                                    <p><strong>Shipping:</strong> Free</p>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn   add-to-cart" data-product-id="guldavariModal"
                                data-bs-dismiss="modal">Add to Cart</button>
                            <button type="button" class="btn btn-success">Buy Now</button>
                        </div>
                    </div>
