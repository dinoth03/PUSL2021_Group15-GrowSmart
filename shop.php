                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="categoryDropdown">
                            ...
                            <li><button class="dropdown-item filter-btn"
                                    data-category="fertilizers">Fertilizers</button></li>
                        </ul>
                    </li>
                    <li class="nav-item">
            ...
            foreach ($categories as $category) {
                ...
                foreach ($products as $row) {
                    if (strtolower($row['category']) === $category) {
                        ...
                        ?>
                        <div class="col-md-3 product-card" data-category="<?= $row['category'] ?>"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn add-to-cart cart-button" data-product-id="<?= $modalId ?>">Add
                                        to Cart</button>
                                    <button type="button" class="btn buy-now cart-button"
                                        onclick="window.location.href='delivery.html';">Buy Now</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img src="<?= $row['imageurl'] ?>" class="img-fluid"
                                                    alt="<?= $row['productname'] ?>">
                                            </div>
                                            <div class="col-md-6">
